...
static const struct behavior_parameter_value_metadata no_arg_values[] = {
    ...
    {
        .display_name = "Indicators On",
        .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE,
        .value = LED_MAP_IND_ON_CMD,
    },
    {
        .display_name = "Indicators Off",
        .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE,
        .value = LED_MAP_IND_OFF_CMD,
    },
    {
        .display_name = "Show Battery",
        .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE,
        .value = LED_MAP_BAT_CMD,
    },
    {
        .display_name = "Next Sub Effect",
        .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE,
        .value = LED_MAP_SUB_EFF_CMD,
    },
    {
        .display_name = "Previous Sub Effect",
        .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE,
...
static int on_keymap_binding_pressed(struct zmk_behavior_binding *binding,
    ...
    case LED_MAP_BAT_CMD:
        return zmk_led_map_show_battery();
    case LED_MAP_SUB_EFF_CMD:
